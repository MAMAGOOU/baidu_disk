package com.rocket.pan.server.modules.share.controller;
...
import com.rocket.pan.server.common.annotation.NeedShareCode;
import com.rocket.pan.server.common.utils.ShareIdUtil;
...
import com.rocket.pan.server.modules.share.converter.ShareConverter;
import com.rocket.pan.server.modules.share.po.CancelSharePO;
import com.rocket.pan.server.modules.share.po.CheckShareCodePO;
import com.rocket.pan.server.modules.share.po.CreateShareUrlPO;
import com.rocket.pan.server.modules.share.po.ShareSavePO;
...
public class ShareController {
    ...
    public R<RPanShareUrlVO> create(@Validated @RequestBody CreateShareUrlPO createShareUrlPO) {
        ...
        List<Long> shareFileIdList = Splitter.on(RPanConstants.COMMON_SEPARATOR).splitToList(shareFileIds)
    ...
    public R cancelShare(@Validated @RequestBody CancelSharePO cancelSharePO) {
        ...
        List<Long> shareIdList = Splitter.on(RPanConstants.COMMON_SEPARATOR).splitToList(shareIds)
                .stream().map(IdUtil::decrypt).collect(Collectors.toList());
