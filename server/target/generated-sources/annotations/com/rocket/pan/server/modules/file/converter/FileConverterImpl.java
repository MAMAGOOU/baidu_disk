...
import com.rocket.pan.server.modules.file.context.DeleteFileContext;
import com.rocket.pan.server.modules.file.context.FileChunkMergeAndSaveContext;
import com.rocket.pan.server.modules.file.context.FileChunkMergeContext;
import com.rocket.pan.server.modules.file.context.FileChunkSaveContext;
import com.rocket.pan.server.modules.file.context.FileChunkUploadContext;
import com.rocket.pan.server.modules.file.context.FileSaveContext;
import com.rocket.pan.server.modules.file.context.FileUploadContext;
...
import com.rocket.pan.server.modules.file.po.FileChunkUploadPO;
import com.rocket.pan.server.modules.file.po.FileUploadPO;
...
public class FileConverterImpl implements FileConverter {
    ...
    public CreateFolderContext createFolderPO2CreateFolderContext(CreateFolderPO createFolderPO) {
        ...
        createFolderContext.setParentId( com.rocket.pan.core.utils.IdUtil.decrypt(createFolderPO.getParentId()) );
        createFolderContext.setUserId( com.rocket.pan.server.common.utils.UserIdUtil.get() );
    ...
    public UpdateFilenameContext updateFilenamePO2UpdateFilenameContext(UpdateFilenamePO updateFilenamePO) {
        ...
        updateFilenameContext.setFileId( com.rocket.pan.core.utils.IdUtil.decrypt(updateFilenamePO.getFileId()) );
        updateFilenameContext.setUserId( com.rocket.pan.server.common.utils.UserIdUtil.get() );
    ...
    public DeleteFileContext deleteFilePO2DeleteFileContext(DeleteFilePO deleteFilePO) {
        ...
        deleteFileContext.setUserId( com.rocket.pan.server.common.utils.UserIdUtil.get() );
    ...
    public SecUploadFileContext secUploadFilePO2SecUploadFileContext(SecUploadFilePO secUploadFilePO) {
        ...
        secUploadFileContext.setParentId( com.rocket.pan.core.utils.IdUtil.decrypt(secUploadFilePO.getParentId()) );
        secUploadFileContext.setUserId( com.rocket.pan.server.common.utils.UserIdUtil.get() );
    ...
    public FileUploadContext fileUploadPO2FileUploadContext(FileUploadPO fileUploadPO) {
        ...
        fileUploadContext.setParentId( com.rocket.pan.core.utils.IdUtil.decrypt(fileUploadPO.getParentId()) );
        fileUploadContext.setUserId( com.rocket.pan.server.common.utils.UserIdUtil.get() );
    ...
    public FileChunkUploadContext fileChunkUploadPO2FileChunkUploadContext(FileChunkUploadPO fileChunkUploadPO) {
        ...
        fileChunkUploadContext.setUserId( com.rocket.pan.server.common.utils.UserIdUtil.get() );
    ...
    public QueryUploadedChunksContext queryUploadedChunksPO2QueryUploadedChunksContext(QueryUploadedChunksPO queryUploadedChunksPO) {
        ...
        queryUploadedChunksContext.setUserId( com.rocket.pan.server.common.utils.UserIdUtil.get() );
    ...
    public FileChunkMergeContext fileChunkMergePO2FileChunkMergeContext(FileChunkMergePO fileChunkMergePO) {
        ...
        fileChunkMergeContext.setUserId( com.rocket.pan.server.common.utils.UserIdUtil.get() );
        fileChunkMergeContext.setParentId( com.rocket.pan.core.utils.IdUtil.decrypt(fileChunkMergePO.getParentId()) );
